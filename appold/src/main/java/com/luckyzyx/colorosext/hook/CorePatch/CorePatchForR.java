package com.luckyzyx.colorosext.hook.CorePatch;
...
import com.luckyzyx.colorosext.BuildConfig;
...
//        Log.d(TAG, "digestCreak" + prefs.getBoolean("digestCreak->", true));
//        Log.d(TAG, "UsePreSig" + prefs.getBoolean("UsePreSig->", false));
